...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['confirm_loan'])) {
    ...
    if ($stmt->execute()) {
        ...
        generateReceipt($user_id, 0, "LAINAKUITTI: " . $laite_nimi . " - Lainattu " . date('d.m.Y', strtotime($lainaus_pvm)), null, $loan_id, null);

        header("Location: admin_laitelainat.php?success=loaned");
        exit();
    } else {
        $error_message = "Varaus epäonnistui. Yritä uudelleen.";
    }
}
...
<head>
    ...
    <title>Varaa Laite | <?php echo htmlspecialchars($device['merkki'] . ' ' . $device['malli']); ?></title>
    ...
    <style>
        * {
        ...
        /* Eri värit eri optioneille */
        .form-control option[value="erinomainen"] {
            background: rgba(16, 185, 129, 0.2);
            color: #10b981;
        }

        .form-control option[value="hyvä"] {
            background: rgba(59, 130, 246, 0.2);
            color: #3b82f6;
        }

        .form-control option[value="tyydyttävä"] {
            background: rgba(245, 158, 11, 0.2);
            color: #f59e0b;
        }

        .form-control option[value="huono"] {
...
<div class="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <a href="admin_laitelainat.php" class="menu-item <?php echo $current_page == 'admin_laitelainat.php' ? 'active' : ''; ?>">
    ...
    <div class="main-content">
        ...
        <div class="top-bar">
            <div class="page-title">
                <h1>Varaa Laite</h1>
                <p><i class="fas fa-circle"></i> Vahvista varaus</p>
            </div>
        ...
        <div class="loan-card">
            ...
            <div class="device-header">
                ...
                <div class="device-info">
                    ...
                    <p>
                        ...
                        <span style="background: rgba(16,185,129,0.15); color: #10b981; padding: 4px 12px; border-radius: 30px; font-size: 0.8rem; margin-left: 10px;">
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">30 päivää</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Eräpäivä:</span>
                    <span class="info-value"><?php echo date('d.m.Y', strtotime('+30 days')); ?></span>
                </div>
            </div>

            <form method="POST" action="">
                <div class="form-group">
                    <label for="lainaus_kunto">Laitteen kunto varaushetkellä</label>
                ...
                <div class="terms">
                    ...
                    Vahvistamalla varauksen sitoudut noutamaan laitteen 7 päivän kuluessa. Mikäli et nouda laitetta ajoissa, varaus peruuntuu automaattisesti.
                </div>

                <button type="submit" name="confirm_loan" class="btn btn-primary">
                    <i class="fas fa-check-circle"></i> Vahvista varaus
                </button>
