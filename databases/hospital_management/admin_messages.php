...
$current_user_name = ($_SESSION['first_name'] ?? 'Admin') . ' ' . ($_SESSION['last_name'] ?? '');
?>
...
<head>
    ...
    <title>Admin Messages - Hospital Management System</title>
...
<div class="main-container">
    <div class="sidebar">
        <div class="sidebar-header">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="admin_messages.php" class="active"><i class="bi bi-chat-dots"></i> Messages</a></li>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4" style="margin-top: 70px;">
            <div>
                <h1 class="h3 mb-1"><i class="bi bi-chat-dots me-2"></i>Admin Messages</h1>
                <p class="text-muted">Manage and view all messages sent to administrators</p>
            </div>
            ...
            <div class="card-body">
                <?php if (empty($messages)): ?>
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">Messages sent to administrators will appear here</p>
                    </div>
                <?php else: ?>
