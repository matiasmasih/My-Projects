...
if (isset($_POST['submit'])) {
    ...
    if (empty($name)) {
        ...
        $stmt = $pdo->prepare("INSERT INTO authors (name, bio, email) VALUES (?, ?, ?)");
        $result = $stmt->execute([$name, $bio ?: null, $email ?: null]);

        if ($result) {
            $_SESSION['user-added'] = "<div class='alert alert-success'>Author added successfully!</div>";
...
<div class="container-display">
    ...
    <form method="post" action="">
        ...
        <button type="submit" name="submit" class="btn btn-dark border border-light">Add Author</button>
