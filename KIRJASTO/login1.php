...
if (isset($_POST['email']) && isset($_POST['password'])) {
    ...
    $stmt = $pdo->prepare("SELECT * FROM register WHERE email = :email AND password = :password");
    ...
    if ($user) {
        ...
        // Handle "remember me" feature safely
 ...
 <div style="width: 50%">
  ...
  <form action="login1.php" method="post">
    <div class="mb-3">
     ...
     <input type="email" class="form-control" name="email" value="<?php echo $id; ?>" id="exampleInputEmail1" placeholder="esimerkki@gmail.com" aria-describedby="emailHelp">
     <?php
